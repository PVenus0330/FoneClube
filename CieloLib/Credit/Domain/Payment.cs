...
namespace CieloLib.Credit.Domain
{
	public class Payment
	{
		...
		public CieloLib.Credit.Domain.CreditCard CreditCard
		{
			get;
			set;
		}
		...
		//public CieloLib.Credit.Domain.ResponseCode ResponseCode
		//{
		//	get;
		//	set;
		//}
		...
		public Payment()
		{
			this.CreditCard = new CieloLib.Credit.Domain.CreditCard();
		}
	}
}